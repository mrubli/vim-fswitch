...
augroup fswitch_au_group
    ...
    au BufEnter *.cc,*.cpp,*.cxx    call s:SetVariables('h,hh,hpp,hxx',     'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.C                 call s:SetVariables('H',                'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.m                 call s:SetVariables('h',                'reg:/src/include/,reg:|src|include/**|,ifrel:|/src/|../include|')
    au BufEnter *.h                 call s:SetVariables('c,cc,cpp,cxx,m',   'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
    au BufEnter *.hh,*.hpp,*.hxx    call s:SetVariables('cc,cpp,cxx',       'reg:/include/src/,reg:/include.*/src/,ifrel:|/include/|../src|')
